...
namespace galdino.humanResource.Web_cli.Configurations.Dependency
{
    public class DependencyInjectionConfiguration
    {
        public static void Register(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IUserIntegration, UserIntegration>(provider => new UserIntegration(configuration.GetSection("ApiConfiguration").GetSection("URL").Value,
                configuration.GetSection("ApiConfiguration").GetSection("Versao").Value));
